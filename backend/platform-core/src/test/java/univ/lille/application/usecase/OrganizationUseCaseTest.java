...
class OrganizationUseCaseTest {
    ...
    void createCustomRole_should_create_role_when_admin_in_org_and_name_not_used() {
        ...
        // WHEN
        CustomRoleDTO result =organizationUseCase.createCustomRole(request, orgId, adminId);
    ...
    void createCustomRole_should_throw_AccessDenied_when_admin_not_in_org() {
        ...
        // WHEN + THEN
        assertThatThrownBy(() ->
                organizationUseCase.createCustomRole(request, orgId, adminId)
        )
    ...
    void updateCustomRole_should_update_fields_and_save() {
        ...
        CustomRoleDTO result =
                organizationUseCase.updateCustomRole(roleId, orgId, adminId, request);
    ...
    void deleteCustomRole_should_remove_role_from_users_and_delete() {
        ...
        // WHEN
        organizationUseCase.deleteCustomRole(roleId, orgId, adminId);
    ...
    void getCustomRolesByOrganization_should_return_mapped_list() {
        ...
        List<CustomRoleDTO> result =
                organizationUseCase.getCustomRolesByOrganization(orgId);
